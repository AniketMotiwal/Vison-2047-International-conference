...
export default function Footer() {
  const [visits, setVisits] = useState<number | string>(0);

  useEffect(() => {
    fetch("https://api.countapi.xyz/hit/vision2047-iitr/visits")
      .then((res) => res.json())
  ...
  return (
    ...
    >
      <style>{`
        ...
        .blue-strip {
          background: linear-gradient(90deg, #003D7A 0%, #0056C7 100%);
          padding: 20px 40px;
          display: flex;
